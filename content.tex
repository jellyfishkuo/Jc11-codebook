...
\section{字串}
    ...
    \subsection{Manacher}
        \input{字串/manacher.tex} \columnbreak
    \subsection{KMP}
...
\section{math}
    ...
    \subsection{高斯消去}
        \input{math/Gaussian Elimination.tex}
    \subsection{Extended GCD}
        \input{math/ExtendedGCD.tex} \columnbreak
    \subsection{大步小步}
...
\section{algorithm}
    ...
    %     \lstinputlisting{algorithm/basic.cpp}
    \subsection{二分搜}
        \lstinputlisting{algorithm/二分搜.cpp} \columnbreak
    \subsection{三分搜}
    ...
    \subsection{dijkstra}
        \lstinputlisting{algorithm/dijkstra.cpp} \columnbreak
    \subsection{SPFA}
    ...
    \subsection{BCC 邊}
        \lstinputlisting{algorithm/BCC_邊.cpp} \columnbreak
    \subsection{BCC 點}
        \lstinputlisting{algorithm/BCC_點.cpp} \columnbreak
    ...
    \subsection{Astar}
        \lstinputlisting{algorithm/Astar.cpp} \columnbreak
    \subsection{LCA倍增法}
        \lstinputlisting{algorithm/LCA倍增法.cpp} \columnbreak
    \subsection{LCA樹壓平RMQ}
        \lstinputlisting{algorithm/LCA樹壓平RMQ.cpp}
    \subsection{LCA樹鍊剖分}
        \lstinputlisting{algorithm/LCA樹鍊剖分.cpp} \columnbreak
    \subsection{二維偏序/CDQ分治}
        \lstinputlisting{algorithm/二維偏序CDQ分治.cpp} \columnbreak
    \subsection{2-SAT(2-Satisfiability)}
        \lstinputlisting{algorithm/2-SAT(2-Satisfiability).cpp}
\clearpage
...
\section{DataStructure}
    ...
    \subsection{帶權併查集}
        \input{DataStructure/weightedDSU.tex} \columnbreak
    \subsection{Trie}
    ...
    \subsection{基礎線段樹（開點 / 區間乘加 / 雙懶標）}
        \lstinputlisting{DataStructure/基礎線段樹（開點區間乘加雙懶標）.cpp} \columnbreak
    \subsection{主席樹}
        \lstinputlisting{DataStructure/PersistentSegmentTree.cpp}
\clearpage
...
\section{Geometry}
    ...
    \subsection{半平面相交}
        \input{Geometry/halfplane_intersection.tex}
    \subsection{Polygon}
        \lstinputlisting{Geometry/polygon.cpp} \columnbreak
        \subsection{凸包}
        \input{Geometry/convex_hull.tex}
        \subsection{最小圓覆蓋}
...
\section{DP}
    ...
    \subsection{WeightedLIS}
        \lstinputlisting{DP/WeightedLIS_無註解.cpp} \columnbreak
    \subsection{數位 DP}
        \lstinputlisting{DP/DigitDP.cpp} \columnbreak
    \subsection{狀態壓縮 DP (Bitmask DP / 輪廓線 DP)}
        \lstinputlisting{DP/狀態壓縮DP(BitmaskDP輪廓線DP).cpp}
\clearpage
